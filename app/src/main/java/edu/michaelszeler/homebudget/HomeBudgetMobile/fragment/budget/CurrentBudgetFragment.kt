...
import edu.michaelszeler.homebudget.HomeBudgetMobile.fragment.budget.tab.CustomExpensesTabFragment
import edu.michaelszeler.homebudget.HomeBudgetMobile.fragment.budget.tab.GeneralTabFragment
import edu.michaelszeler.homebudget.HomeBudgetMobile.fragment.budget.tab.RegularExpensesTabFragment
import edu.michaelszeler.homebudget.HomeBudgetMobile.fragment.budget.tab.StrategiesTabFragment
...
class CurrentBudgetFragment : Fragment() {
    ...
    private inner class BudgetPagerAdapter(activity: FragmentActivity?) : FragmentStateAdapter(
        activity!!
    ), Updatable {
